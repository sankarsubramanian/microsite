...
<div id="wrapper">
  ...
  <div>
    ...
    <?php $site_name = "AT&T Developer"; if ($site_name): ?><div style="float:left;"><h1 id="site-title"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></h1></div><?php endif; ?>
    </div>
    ...
    <nav id="main-menu"  role="navigation">
      <a class="nav-toggle" href="#"><?php print t("Main Menu"); ?></a>
